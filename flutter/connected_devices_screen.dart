...
class _ConnectedDevicesScreenState extends State<ConnectedDevicesScreen> {
  ...
  Future<void> _fetchConnectedDevices() async {
    ...
    try {
      final devices = await apiService.deviceList();
      setState(() {
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          Text('UUID: ${d['device_uuid'] ?? 'Unknown'}'),
                          Text('Last seen: ${d['last_seen_at'] ?? 'Unknown'}'),
                          Text(
                            '${d['device_type'] ?? 'unknown'} • ${d['connection_type'] ?? 'unknown'}',
